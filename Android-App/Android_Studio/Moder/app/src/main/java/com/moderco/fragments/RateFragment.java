...
import com.moderco.moder.RatingContactAdapter;
...
public class RateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final RecyclerView recList = (RecyclerView) v.findViewById(R.id.cardListRate);
        ...
        RatingContactAdapter ca = new RatingContactAdapter();
        recList.stopScroll();
